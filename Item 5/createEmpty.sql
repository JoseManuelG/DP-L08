CREATE DATABASE  IF NOT EXISTS `acme-bnb` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `acme-bnb`;
...
--
-- Dumping events for database 'acme-bnb'
--

--
-- Dumping routines for database 'acme-bnb'
--
...
-- Dump completed on 2017-06-21 17:03:06
